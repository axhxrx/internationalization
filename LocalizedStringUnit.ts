/**
 A "localized string item" type, which defines the shape of a piece of text content that has been translated into multiple languages as strings, which are defined by the generic type parameter `Locales`.
 ...
 export type AcmeLocalizedStringUnit = LocalizedStringUnit<AcmeLocales>;
 ...
 */
export const isLocalizedStringUnit = <Locales extends string>(
  value: unknown,
): value is LocalizedStringUnit<Locales> =>
{
  if (!value)
  {
    return false;
